  ...
  const features = [
    {
      ...
      description:
      "Access thousands of job listings across various industries and experince levels.",
      benefits: [
...

    {
      ...
      title: "Top Companies",
      description:
      "Connect with leading companies, from innovative startups to Foetune 500 corporations",
      benefits: [
...

    {
      ...
      title: "Talent Pool",
      description:
      "Employers can access a diverse pool of qualified candidates for their open position",
      benefits: [
  ...
  <main>
    ...
    <section className="py-20 bg-[#f0f5fa]">
      <div className="container mx-auto px-4">
        ...
        <span className="text-[#7263f3] font-extrabold">Job Findr</span>
        </h2>
